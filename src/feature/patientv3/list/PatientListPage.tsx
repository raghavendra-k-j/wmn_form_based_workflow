...
/** 
 * Patient List Page V3 - integrated design with sticky header and no external padding.
 */
export function PatientListPageV3() {
    ...
    <div className="h-full bg-white flex flex-col text-[13px] overflow-hidden">
      ...
      <div className="h-14 px-6 border-b border-zinc-200 flex items-center justify-between bg-white shrink-0 z-20">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            onClick={() => navigate('/patientv3/new')}
        ...
        <table className="w-full border-collapse">
          ...
          <tbody className="divide-y divide-zinc-100">
            {filtered.map((p, i) => (
              <tr 
                key={p.id}
                onClick={() => navigate(`/patientv3/${p.id}`)}
              ...
              >
                ...
                <td className="py-4 px-6 text-right">
                  <div className="flex items-center justify-end gap-1 opacity-60 group-hover:opacity-100 transition-opacity">
                    ...
                    <button 
                      onClick={(e) => { e.stopPropagation(); navigate(`/patientv3/${p.id}`); }}
...
export default PatientListPageV3;
