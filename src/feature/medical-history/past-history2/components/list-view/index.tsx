...
export const ListView = observer(() => {
  ...
  const handleClearAllData = async () => {
    if (confirm('⚠️ This will delete ALL past history records for this patient. This action cannot be undone. Continue?')) {
      try {
        await pastHistoryService.clearAllRecords(store.patientId);
        // Reload records
