...
export const PastHistoryForm = observer(() => {
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-200">
              <th className="px-3 py-2.5 text-[11px] font-semibold text-gray-700 text-left uppercase tracking-wide" style={{ width: '14%' }}>
                Condition
              </th>
...
PastHistoryForm.displayName = 'PastHistoryForm';
