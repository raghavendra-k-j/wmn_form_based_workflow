...
import type { PatientSurgicalHistory } from '../../types';

interface ProcedureRowProps {
  item: PatientSurgicalHistory;
}

export const ProcedureRow = observer(({ item }: ProcedureRowProps) => {
  ...
  // Check if procedure is "active" (not "No" for single select, has selections for multi-select)
  const isActive = (() => {
