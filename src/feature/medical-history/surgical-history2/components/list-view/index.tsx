...
export const ListView = observer(() => {
  ...
  const handleClearAllData = async () => {
    if (confirm('⚠️ This will delete ALL surgical history records for this patient. This action cannot be undone. Continue?')) {
      try {
        await surgicalHistoryService.clearAllRecords(store.patientId);
