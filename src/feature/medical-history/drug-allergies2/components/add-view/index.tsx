...
import { DrugAllergiesForm } from './drug-allergies-form';
...
export const AddView = observer(() => {
  ...
  return (
    <div className="space-y-4">
      ...
      {store.hasDrugAllergies === true && <DrugAllergiesForm />}
      ...
      {store.hasDrugAllergies === false && (
        <div className="border border-gray-200 bg-white relative">
          {store.saveState === 'saving' ? (
            ...
            <EmptyState message="No drug allergies" submessage="This has been recorded" />
          )}
          {store.isSaved && (
