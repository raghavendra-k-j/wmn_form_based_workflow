...
export { CombinedScreeningPage } from './combined-screening/page';
export { AnomalyScanPage } from './anomaly-scan/page';
export { GrowthScanPage } from './growth-scan/page';
export { OtherInvestigationsPage } from './other-investigations/page';
