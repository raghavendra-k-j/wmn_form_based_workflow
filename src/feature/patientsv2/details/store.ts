/** Case types for patient visits */
export type CaseType = 'anc' | 'pnc' | 'gynae';

export const CaseType = {
  ANC: 'anc' as const,
  PNC: 'pnc' as const,
  GYNAE: 'gynae' as const,
};
...
/** Patient Details Store - Manages patient details state and actions */
export class PatientDetailsStore {
  patientId: string;
  ...
  /** Set current active case context */
  setCase(caseType: CaseType | null, caseId?: string | null) {
